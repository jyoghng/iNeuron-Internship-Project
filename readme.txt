...
Step 2 : Create a new environment
	...
	command : conda create -n EplepticDisorder python==3.6.9

Step 3 : activate your environment
                
	Command: conda activate EplepticDisorder
...
. 
	    For me ( E:\PyCharmProjects\EpilepticDisorder )
                 
	    For you - you folderName
